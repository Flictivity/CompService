...
{
    private readonly IMongoCollection<SparePartCategory> _categories;
    ...
    public async Task UpdateReference(SparePartCategory? currentRef, SparePartCategory newRef)
    {
        ...
        var newDbRef = new SparePartCategory
        {
